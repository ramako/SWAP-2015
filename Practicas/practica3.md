...
Al hacer dos curl a la ip de la maquina balanceadora de carga, vemos como alterna las páginas, sin embargo accediendo desde el anfitrión
esto no ocurre con la frecuencia que debería.

He añadido weight=2 en la primera máquina, y de cada 3 conexiones 2 van a la primera máquina y 1a la segunda tanto desde el anfitrion como
desde curl.
